package com.example.android.automata.Automatons.TuringMachine;
...
public class Turing extends AppCompatActivity {
    ...
    List<EditText> qi = new ArrayList<EditText>(), symbol= new ArrayList<EditText>(), qf= new ArrayList<EditText>(), replace = new ArrayList<>(), lr = new ArrayList<>();
    ArrayList<String> initialStates = new ArrayList<>(), symbols=new ArrayList<>(),
            finalState = new ArrayList<>();
    ArrayList<Character> replacement = new ArrayList<>(), l_r = new ArrayList<>();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validationSuccess(noofstates)){
                    ...
                    Toast.makeText(Turing.this,"Please enter the no of states",Toast.LENGTH_SHORT).show();
                }
                if (validationSuccess(transitions)){
                    ...
                    Toast.makeText(Turing.this, "Please enter the number of transitions",Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                if (flag==false) return;
                Intent intent = new Intent(Turing.this,DefinitionActivity.class);
        ...
        diagram.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                boolean flag = transitionDiagram();
                if (flag==false) return;
                Intent intent = new Intent(Turing.this,TransitionDiagram.class);
                Bundle bundle = new Bundle();
                bundle.putInt(ConstantsClass.Size,size);
                bundle.putInt(ConstantsClass.NofStates,noofstate);
                bundle.putStringArrayList(ConstantsClass.InitialStates, initialStates);
        ...
        simulation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                boolean flag = transitionDiagram();
                if (flag==false) return;
                Intent intent = new Intent(Turing.this,SimulationActivity.class);
                Bundle bundle = new Bundle();
                bundle.putInt(ConstantsClass.Size,size);
                bundle.putInt(ConstantsClass.NofStates,noofstate);
                bundle.putStringArrayList(ConstantsClass.InitialStates, initialStates);
    ...
    public boolean transitionDiagram(){
        ...
        for (int i=0;i<qi.size();++i){
            ...
            if (flag == false){
                Toast.makeText(Turing.this,"Enter correct initial states in the transition table",Toast.LENGTH_SHORT).show();
                return false;
            }
        ...
        for (int i=0;i<symbol.size();++i){
            ...
            String str = editText.getText().toString().trim();
            if (str.equals("")){
                Toast.makeText(Turing.this,"Enter a valid character symbol",Toast.LENGTH_SHORT).show();
                return false;
            }
            Character character = str.charAt(0);
            //TODO - change symbols arraylist of string to char
            Boolean flag = false;
...
//            }
        ...
        for (int i=0;i<qf.size();++i){
            ...
            if (flag == false){
                Toast.makeText(Turing.this,"Enter correct final states in the transition table",Toast.LENGTH_SHORT).show();
                return false;
            }
            finalState.add(str);
        }
        ...
        for (int i=0;i<replace.size();++i){
            EditText editText = replace.get(i);
            ...
            replacement.add(character);
        }

        for (int i=0;i<lr.size();++i){
            EditText editText = lr.get(i);
            String str = editText.getText().toString();
            if (str.equals("")){
                Toast.makeText(Turing.this,"Enter a valid direction symbol",Toast.LENGTH_SHORT).show();
                return false;
            }
            Character character = str.charAt(0);
            Boolean flag = false;
            for (int j=0;j<noofstate;++j){
                if (character=='l' || character=='L' || character=='r' || character =='R'){
                    flag = true;
                    break;
                }
            }
            if (flag == false){
                Toast.makeText(Turing.this,"Enter direction of movement in the transition table",Toast.LENGTH_SHORT).show();
                return false;
            }
            l_r.add(character);
        }
    ...
    public void enter(final EditText noofstates){
        ...
        if (no<1 || no>10){
            Toast.makeText(Turing.this,"Please enter values in the range!",Toast.LENGTH_SHORT).show();
            return;
        }
        noofstate = no;
        String ans = states[0];
    ...
    public boolean drawtable(){
        if (isDrawn==false)
            ...
            Toast.makeText(Turing.this,"Error! Please reset and mention all fields",Toast.LENGTH_SHORT).show();
            isDrawn = true;
            return false;
        }
        rootLayout = findViewById(R.id.rootLayout);
        ...
        if (initialState.equals("")){
            Toast.makeText(Turing.this, "Enter a valid initial state",Toast.LENGTH_SHORT).show();
            return false;
        }
        boolean flag = false;
        ...
        for (int j=0;j<finalStates.length;++j){
            ...
            if (flag == false){
                Toast.makeText(Turing.this, "Enter a valid final state",Toast.LENGTH_SHORT).show();
                return false;
            }
        }
        ...
        if (size<1 || size>25){
            Toast.makeText(Turing.this,"Please enter a value in the range!",Toast.LENGTH_SHORT).show();
            return false;
        }
        Log.d("tag",size+"");
        ...
        for (int i=1;i<size;++i){
            for (int j=0;j<5;++j){
                EditText l1 = new EditText(Turing.this);
