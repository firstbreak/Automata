        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validationSuccess(noofstates)){
                    ...
                    Toast.makeText(DFA.this,"Please enter the no of states",Toast.LENGTH_SHORT).show();
                }
                if (validationSuccess(transitions)){
                    ...
                    Toast.makeText(DFA.this, "Please enter the number of transitions",Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                if (flag==false) return;
                Intent intent = new Intent(DFA.this,DefinitionActivity.class);
        ...
        diagram.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                boolean flag = transitionDiagram();
                if (flag==false) return;
                Intent intent = new Intent(DFA.this,TransitionDiagram.class);
                Bundle bundle = new Bundle();
                bundle.putInt(ConstantsClass.Size,size);
                bundle.putInt(ConstantsClass.NofStates,noofstate);
                bundle.putStringArrayList(ConstantsClass.InitialStates, initialStates);
        ...
        simulation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                boolean flag = transitionDiagram();
                if (flag==false) return;
                Intent intent = new Intent(DFA.this,SimulationActivity.class);
                Bundle bundle = new Bundle();
                bundle.putInt(ConstantsClass.Size,size);
                bundle.putInt(ConstantsClass.NofStates,noofstate);
                bundle.putStringArrayList(ConstantsClass.InitialStates, initialStates);
    ...
    public boolean transitionDiagram(){
        ...
        for (int i=0;i<qi.size();++i){
            ...
            if (flag == false){
                Toast.makeText(DFA.this,"Enter correct initial states in the transition table",Toast.LENGTH_SHORT).show();
                return false;
            }
...
//            }
        ...
        for (int i=0;i<qf.size();++i){
            ...
            if (flag == false){
                Toast.makeText(DFA.this,"Enter correct final states in the transition table",Toast.LENGTH_SHORT).show();
                return false;
            }
            finalState.add(str);
        }
    ...
    public void enter(final EditText noofstates){
        ...
        if (no<1 || no>10){
            Toast.makeText(DFA.this,"Please enter values in the range!",Toast.LENGTH_SHORT).show();
            return;
        }
        noofstate = no;
        String ans = states[0];
    ...
    public boolean drawtable(){
        ...
        isDrawn = true;
            ...
            Toast.makeText(DFA.this,"Error! Please reset and mention all fields",Toast.LENGTH_SHORT).show();
            isDrawn = true;
            return false;
        }
        rootLayout = findViewById(R.id.rootLayout);
        ...
        if (initialState.equals("")){
            Toast.makeText(DFA.this, "Enter a valid initial state",Toast.LENGTH_SHORT).show();
            return false;
        }
        boolean flag = false;
        ...
        for (int j=0;j<finalStates.length;++j){
            ...
            if (flag == false){
                Toast.makeText(DFA.this, "Enter a valid final state",Toast.LENGTH_SHORT).show();
                return false;
            }
        }
        ...
        if (size<1 || size>25){
            Toast.makeText(DFA.this,"Please enter a value in the range!",Toast.LENGTH_SHORT).show();
            return false;
        }
        Log.d("tag",size+"");
        ...
        rows[0].addView(l);
        TextView m = new TextView(DFA.this);
        ...
        rows[0].addView(m);
        TextView n = new TextView(DFA.this);
        ...
        for (int i=1;i<size;++i){
            for (int j=0;j<3;++j){
                EditText l1 = new EditText(DFA.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.reset:
                Intent intent = new Intent(DFA.this,DFA.class);
                startActivity(intent);
                return true;
