package com.example.android.automata.Automatons.NPDA;
...
public class NPDA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_npda);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validationSuccess(noofstates)){
                    ...
                    Toast.makeText(NPDA.this,"Please enter the no of states",Toast.LENGTH_SHORT).show();
                }
                if (validationSuccess(transitions)){
                    ...
                    Toast.makeText(NPDA.this, "Please enter the number of transitions",Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                if (flag==false) return;
                Intent intent = new Intent(NPDA.this,DefinitionActivity.class);
        ...
        diagram.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                boolean flag = transitionDiagram();
                if (flag==false) return;
                Intent intent = new Intent(NPDA.this,TransitionDiagram.class);
                Bundle bundle = new Bundle();
                bundle.putInt(ConstantsClass.Size,size);
                bundle.putInt(ConstantsClass.NofStates,noofstate);
                bundle.putStringArrayList(ConstantsClass.InitialStates, initialStates);
        ...
        simulation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                boolean flag = transitionDiagram();
                if (flag==false) return;
                Intent intent = new Intent(NPDA.this,SimulationActivity.class);
                Bundle bundle = new Bundle();
                bundle.putInt(ConstantsClass.Size,size);
                bundle.putInt(ConstantsClass.NofStates,noofstate);
                bundle.putStringArrayList(ConstantsClass.InitialStates, initialStates);
    ...
    public boolean transitionDiagram(){
        ...
        for (int i=0;i<qi.size();++i){
            ...
            if (flag == false){
                Toast.makeText(NPDA.this,"Enter correct initial states in the transition table",Toast.LENGTH_SHORT).show();
                return false;
            }
...
//            }
        ...
        for (int i=0;i<qf.size();++i){
            ...
            if (flag == false){
                Toast.makeText(NPDA.this,"Enter correct final states in the transition table",Toast.LENGTH_SHORT).show();
                return false;
            }
            finalState.add(str);
        }
    ...
    public void enter(final EditText noofstates){
        ...
        if (no<1 || no>10){
            Toast.makeText(NPDA.this,"Please enter values in the range!",Toast.LENGTH_SHORT).show();
            return;
        }
        noofstate = no;
        String ans = states[0];
    ...
    public boolean drawtable(){
        if (isDrawn==false)
            ...
            Toast.makeText(NPDA.this,"Error! Please reset and mention all fields",Toast.LENGTH_SHORT).show();
            isDrawn = true;
            return false;
        }
        rootLayout = findViewById(R.id.rootLayout);
        ...
        if (initialState.equals("")){
            Toast.makeText(NPDA.this, "Enter a valid initial state",Toast.LENGTH_SHORT).show();
            return false;
        }
        boolean flag = false;
        ...
        for (int j=0;j<finalStates.length;++j){
            ...
            if (flag == false){
                Toast.makeText(NPDA.this, "Enter a valid final state",Toast.LENGTH_SHORT).show();
                return false;
            }
        }
        ...
        if (t.equals("")){
            Toast.makeText(NPDA.this,"Enter a valid Top of Stack character",Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        if (size<1 || size>25){
            Toast.makeText(NPDA.this,"Please enter a value in the range!",Toast.LENGTH_SHORT).show();
            return false;
        }
        Log.d("tag",size+"");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.reset:
                Intent intent = new Intent(NPDA.this,NPDA.class);
                startActivity(intent);
                return true;
